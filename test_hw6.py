...
class Test(unittest.TestCase):
    ...
    def test07(self):
        sequence = '011' * 16
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '0000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100010')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
        self.assertAlmostEqual(hw6.compression(sequence), 3.3333, 4)
        
    def test08(self):
        sequence = '101' * 16
        compress = hw6.compress(sequence)
        self.assertEqual(compress, '00000000010000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100010000010001000001000100000100001')
        uncompress = hw6.uncompress(compress)
        self.assertEqual(uncompress, sequence)
